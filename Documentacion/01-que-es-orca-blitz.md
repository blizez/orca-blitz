...
orca-blitz es tu plataforma para gestionar y automatizar tu negocio.
...
Actualmente esta disponible para **computadoras** (Windows, Linux, macOS). Pronto tendremos version para celular y navegador.
