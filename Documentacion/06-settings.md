...
### Appearance (Apariencia) — FUNCIONAL
...
- **Two-Factor Authentication** — Seguridad extra para tu cuenta
- **Active Sessions** — Donde has abierto la app
- **API Keys** — Llaves para conectarte a otros servicios
