        ...
        if (url.pathname === '/auth/callback') {
          ...
          if (code) {
            ...
            try {
              ...
              res.end('<html><body style="font-family:system-ui;display:flex;align-items:center;justify-content:center;height:100vh;margin:0;background:#0a0a0a;color:#fff;"><div style="text-align:center;"><h1>Connected!</h1><p style="color:#888;">You can close this window.</p></div></body></html>')
            } catch (err) {
              mainWindow.webContents.send('openai:auth-error', err instanceof Error ? err.message : 'Token exchange failed')
