...
export const colorThemes: ColorTheme[] = [
  ...
  {
    id: 'deep-purple', name: 'Deep Purple', className: 'theme-deep-purple',
  ...
  {
    id: 'examdedo', name: 'Examdedo', className: 'theme-examdedo',
  ...
  {
    id: 'jamaica', name: 'Jamaica', className: 'theme-jamaica',
  ...
  {
    id: 'my-theme', name: 'MY THEME', className: 'theme-my-theme',
  ...
  {
    id: 'qrafthive', name: 'Qrafthive', className: 'theme-qrafthive',
  ...
  {
    id: 'teal-hue', name: 'Teal Hue', className: 'theme-teal-hue',
  ...
  {
    id: 'terminal-muted', name: 'Terminal Muted', className: 'theme-terminal-muted',
  ...
  {
    id: 'witch-rave', name: 'Witch Rave', className: 'theme-witch-rave',
  ...
  {
    id: 'zen-inspired', name: 'Zen Inspired', className: 'theme-zen-inspired',
